...
class Product():
    '''Defines the attributes and behaviors of the Product class'''
...
class Auction():
    '''Defines the attributes and behaviors of the Auction class'''
...
class Bid():
    '''Defines the attributes and behaviors of the Bid class.'''
