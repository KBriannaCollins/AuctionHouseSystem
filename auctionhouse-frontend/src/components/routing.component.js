...
function UserNav(props) {
    ...
    if (UserLoggedIn && 'role' in UserLoggedIn) {
        if (UserLoggedIn.role.toUpper() === 'MANAGER'){
            ...
            return <Nav className="mr-auto"><Link to='/managelist' className='nav_link'><h3>Manage Auction</h3></Link></Nav>
        ...
        <>
            <Router>
                <Navbar>
                    ...
                    <Nav className="mr-auto"><Link to='/userlist' className='nav_link'><h3>Users List</h3></Link></Nav>
                    <Login></Login>
                </Navbar>
